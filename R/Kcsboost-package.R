...
#' @docType data
#' @aliases creditcard
#' @title Creditcard Transaction Data
#' @description Transactions made by credit cards in September 2013 by European cardholders.
#' This data set presents a small subset of transactions that occurred in two days, where we have 465 frauds out of 1409 transactions.
...
#' The only feature which has not been transformed with PCA is "Amount" which is the transaction amount.
#' Feature "Class" is the response variable which takes value 1 in case of fraud and 0 otherwise.
